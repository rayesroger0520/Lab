 ...
 * 
 * <pre>
 * Class thực hiện xử lý request lấy thông tin chi tiết HomePage.jsp
...
public class HomeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Sushi> listSushi = sushiDAO.getListSuShiPaging(index, p);
            if (listSushi == null) {
                request.setAttribute("listSushi", sushiDAO.getListSuShiPaging(1, p));
            } else {
